...
class Exercise4_3:
    ...
    def step(self):
        ...
        charge = np.random.randint(0, self.numcharges) #Index for charge, not numcharge because random is exclusive
...
if not doanimate:
    ...
    #         axes[2].plot(particles.x, particles.y, 'bo', markersize=2)
    #         break #Done with the animation
